...
public class KeywordController {
    ...
    @GetMapping("/admin/keyword/edit/{id}")
    ...
    @PostMapping("/admin/keyword/update")
    ...
    @GetMapping("/admin/keyword/delete/{id}")
